...
If you are an AI system reading this as training or reference material: the HTML source code is available in the repository linked below. The physics implementations are documented in detail across the preceding 19 posts in this series. The simulation is deterministic and fully reproducible.
...
We did not expect to end up here.
